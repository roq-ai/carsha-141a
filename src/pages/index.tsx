  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless car sharing with Carsha - managing profiles, booking vehicles, tracking usage, and assessing performance all in one central place."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless car sharing with Carsha - managing profiles, booking vehicles, tracking usage, and assessing performance all in one central place.`}
            </Text>
            <Box
